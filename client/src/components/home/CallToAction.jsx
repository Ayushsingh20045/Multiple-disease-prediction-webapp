...
const CallToAction = () => {
  return (
   <div className="max-w-5xl mx-2 md:mx-auto p-px rounded-2xl bg-gradient-to-r from-purple-600/20 to-blue-500/30 mt-32">
            <div className="flex flex-col items-center justify-center text-center py-12 md:py-16 rounded-[15px] bg-gradient-to-r from-[#F3EAFF] to-[#E1EFFF] ">  
                <div className="flex items-center justify-center bg-white px-3 py-1.5 shadow gap-1 rounded-full text-xs">
                    ...
                    <span className="bg-gradient-to-r from-purple-600 to-blue-500 bg-clip-text text-transparent font-medium">Trusted by Doctors & Health Experts</span>
                </div>
                <h2 className="text-2xl md:text-4xl font-medium mt-2 leading-[1.2]">
                    Empowering You with <br />
                    <span className="bg-gradient-to-r from-purple-600 to-blue-500 bg-clip-text text-transparent">Early Detection </span> 
                  and Reliable Predictions!
                </h2>
                <p className="text-slate-500 mt-2 max-w-lg max-md:text-sm">Stay informed, stay safe — get instant results powered by advanced machine learning.</p>
                <button type="button" className="bg-gradient-to-r from-purple-600 to-blue-500 text-white text-sm px-5 py-2.5 rounded-xl font-medium mt-4 hover:scale-105 active:scale-95 transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer"> 
