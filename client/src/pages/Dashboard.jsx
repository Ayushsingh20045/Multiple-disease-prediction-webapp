...
const handlePredict = (type)=>{
  ...
  return (
   <>
     <Navbar/>
      <div className="text-xl px-12 lg:px-36 py-8 ">
...
Our aim is to make healthcare easier, smarter, and preventive by helping users understand their health better and get timely guidance for a safer and healthier future.</p>
  ...
  place-items-center ">
    ...
    <div  className="card  transition-all duration-200 rounded-2xl shadow-xl w-92 flex flex-col items-center justify-center px-2 gap-3 py-6 border-1 border-gray-200">
    <img src="/HeartImg.png" alt="" className='h-38'/>
    ...
    <button onClick={()=> handlePredict("heart")} className='border border-gray-300 px-16 py-2 rounded-3xl text-2xl shadow-lg hover:shadow-xl cursor-pointer'>Predict</button>
    </div>
    ...
    <button onClick={()=> handlePredict("diabetes")}  className='border border-gray-300 px-16 py-2 rounded-3xl text-2xl shadow-lg hover:shadow-xl cursor-pointer'>Predict</button>
    </div>
    
    <div className="card  transition-all duration-200 rounded-2xl shadow-xl w-92 flex flex-col items-center justify-center px-2 gap-3 py-6 border-1 border-gray-200">
    <img src="/Liver.png" alt="" className='h-38'/>
    <h1 className='font-semibold text-3xl '>Liver Disease</h1>
    <p className= 'text-center text-gray-500'>Prediction of liver conditions based on medical markers and key health indicators.</p>
    <button onClick={()=> handlePredict("liver")} className='border border-gray-300 px-16 py-2 rounded-3xl text-2xl shadow-lg hover:shadow-xl cursor-pointer'>Predict</button>
    </div>
