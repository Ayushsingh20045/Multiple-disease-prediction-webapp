...
import { EqualApproximatelyIcon, Loader } from 'lucide-react'
...
const handleSubmit = async(e)=>{
  ...
  <form onSubmit={handleSubmit} >
    ...
    <div className="flex flex-col border-1 border-gray-600  h-[430px] w-[350px]  rounded-xl px-4">
      <h2 className='text-3xl font-semibold text-center pt-5 pb-2 underline'>Log In</h2>
      ...
      <label className='text-xl px-2  mb-1' htmlFor="">Password:</label>
       ...
       <p className='text-sm text-center text-gray-600'>Dont't have an account? <Link to="/register" className='text-[#432DD7] underline'>Signup</Link></p>
    </div>
  </div>
  </form>
   </>
